...
const styles = StyleSheet.create({
  ...
  username: { fontSize: 20, fontWeight: '700', marginTop: 4 },
  starsRow: { flexDirection: 'row', alignItems: 'center', marginTop: 6 },
  starText: { fontSize: 13, fontWeight: '600' },
  ...
  contestRating: { fontSize: 12, marginTop: 2 },
  contestRank: { color: '#66bb6a', fontSize: 14, fontWeight: '600' },
