  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <LinearGradient colors={['#4fc3f7' + '18', colors.cardGradientEnd]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={[styles.headerCard, { borderWidth: 1, borderColor: '#4fc3f7' + '25', shadowColor: '#4fc3f7', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 12, elevation: 4 }]}>
...
const styles = StyleSheet.create({
  ...
  platformLabel: { fontSize: 12, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1 },
  username: { fontSize: 20, fontWeight: '700', marginTop: 2 },
  rank: { fontSize: 13, fontWeight: '600', marginTop: 2, textTransform: 'capitalize' },
  ...
  contestName: { fontSize: 14 },
  deltaRow: { flexDirection: 'row', alignItems: 'center', marginTop: 8 },
  deltaText: { fontSize: 18, fontWeight: '700', marginLeft: 4 },
  ...
  modalSubtitle: { fontSize: 13, textAlign: 'center', marginTop: 6, marginBottom: 20 },
